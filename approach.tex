...
We define a normalised scalar value based on a test's probability of failure --- \emph{\flakiness{}}. A high \flakiness{} value corresponds to a low probability of failure.
...
% Possibly just shove this in the appendix...
