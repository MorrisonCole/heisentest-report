...
Each test can be assigned a flakiness value $f$ in the range $[0-1]$, representing its likihood of failure.

From $f$, we can derive a priority value $p$ relative to other tests in the suite. This is used to determine test budget allocation.
...
\subsection{Instrumentation Pseudocode}
