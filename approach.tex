...
\todo{What value is $\alpha$, how do we calculate it?}
...
We prioritise budget allocation for tests with high flakiness since they fail very rarely. A portion of the total budget is set aside for exploratory instrumentation of tests that have not yet been determined to be flaky.
