...
% For page-specific landscape formatting.
\usepackage{lscape}
...
\newcommand{\jenkinsPlugin}{\emph{Venera Jenkins Plugin}\xspace}
...
% Allow supression of Table of Contents entries
\newcommand{\nocontentsline}[3]{}
...
\hfill Martin Fowler \cite{eradicatingNondeterminismInTests}
