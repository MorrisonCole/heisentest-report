...
\todo{Heisentest is an answer to a real problem. It is obvious that others face
the same issue - Mozilla and Chromium have known flaky tests. Android even
includes an @flaky annotation in its testing kit for automatic rerunning of
known troublesome tests.}
...
\todo{Explain why we are ‘just’ targeting Android for now (GUI testing,
\etc).}
