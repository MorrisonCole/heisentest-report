...
in detail during \autoref{sec:imp}, was ambitious in of itself --- it proved a
significant challenge implementing even the basic features of our proposed
framework.

The tool we produced --- \textit{\venera} --- gathers and analyses information
...
information over a series of test runs. Our tool takes advantage of the
continuous integration environment, gathering data each time an associated test
suite is run. Figure \ref{fig:developer_workflow} shows the high-level \venera
workflow. Previous and potential future work with an industry software startup
lead us to target the Android platform for this initial proof of concept.
