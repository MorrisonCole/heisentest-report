...
Like any real world project with a significant test suite, Shazam on Android is no stranger to flaky tests. Over the period \todo{length in terms of build history} during which we collected build results from their codebase, we saw $N$ tests fail unexpectedly.
